...
CONFIG = ROOT / "downstream-run.openai-luna-v0.3.json"
    ...
    *,
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "semantic-decision-lab-downstream-v0.3",
        },
    )
    try:
...
def main() -> None:
    ...
    if args.dry_run:
        print(
            "downstream v0.3 OpenAI Luna run config valid: "
    ...
    print(f"completed downstream v0.3 run: {len(rows)} responses, 0 parse errors")
