...
REQUESTS = ROOT / "downstream-requests.v0.2.jsonl"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Convert validated v0.2 raw responses into evaluator input without consulting gold."
    )
    ...
    output = {"run": payload["run"], "answers": answers}
